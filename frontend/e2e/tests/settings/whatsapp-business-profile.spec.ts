...
test.describe("WhatsApp Business Profile", () => {
  ...
  test("should view business profile dialog", async ({ page }) => {
    ...
    await expect(accountsPage.profileDialog.locator("input#about")).toHaveValue(
      "Available",
    );
    await expect(accountsPage.profileDialog.locator("input#email")).toHaveValue(
      "test@example.com",
    );
  });
  ...
  test("should update business profile", async ({ page }) => {
    ...
    await accountsPage.profileDialog
